...
import deerflowx.graphs.research.graph.builder as builder_mod
...
@patch("deerflowx.graphs.research.graph.builder.StateGraph")
...
@patch("deerflowx.graphs.research.graph.builder.MemorySaver")
...
def test_graph_is_compiled():
    ...
    with patch("deerflowx.graphs.research.graph.builder._build_base_graph") as mock_base:
        mock_builder = MagicMock()
        ...
        importlib.reload(sys.modules["deerflowx.graphs.research.graph.builder"])
